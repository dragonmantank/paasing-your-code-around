...
cd www/
# cp www/ruckusing.conf.php .
LD_LIBRARY_PATH=$BUILD_DIR/php/ext $BUILD_DIR/php/bin/php -c $BUILD_DIR/php/php.ini bin/ruckus.php db:setup
LD_LIBRARY_PATH=$BUILD_DIR/php/ext $BUILD_DIR/php/bin/php -c $BUILD_DIR/php/php.ini bin/ruckus.php db:migrate